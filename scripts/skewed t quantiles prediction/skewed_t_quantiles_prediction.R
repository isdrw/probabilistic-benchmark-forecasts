...
source("scripts/skewed t quantiles prediction/skewed_t_quantiles_functions.R")
...
with_progress({
  ...
  weo_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_skewed_t(df_weo, country, tau, target, horizon, fit_mean = TRUE)    
      })
...
with_progress({
  ...
  rw_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_skewed_t(df_rw, country, tau, target, horizon, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  ar1_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_skewed_t(df_ar1, country, tau, target, horizon, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  arima1_1_0_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_skewed_t(df_arima1_1_0, country, tau, target, horizon, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  arima_auto_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_skewed_t(df_arima_auto, country, tau, target, horizon, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  rw_q_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_skewed_t(df_rw_q, country, tau, target, horizon, R = 44, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  ar1_q_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_skewed_t(df_ar1_q, country, tau, target, horizon, R = 44, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  arima1_1_0_q_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_skewed_t(df_arima1_1_0_q, country, tau, target, horizon, R = 44, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  arima_auto_q_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_skewed_t(df_arima_auto_q, country, tau, target, horizon, R = 44, fit_mean = TRUE)  
      })
...
write.csv(pred_weo, paste0(
  "results/skewed_t_quantiles_prediction/fitted_mean/skewed_t_prediction_weo_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_weo_eval, paste0(
  "results/skewed_t_quantiles_prediction/fitted_mean/skewed_t_prediction_weo_eval_", 
  timestamp, ".csv"), row.names = FALSE)
...
write.csv(pred_rw, paste0(
  "results/skewed_t_quantiles_prediction/fitted_mean/skewed_t_prediction_rw_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_rw_eval, paste0(
  "results/skewed_t_quantiles_prediction/fitted_mean/skewed_t_prediction_rw_eval_", 
  timestamp, ".csv"), row.names = FALSE)
...
write.csv(pred_ar1, paste0(
  "results/skewed_t_quantiles_prediction/fitted_mean/skewed_t_prediction_ar1_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_ar1_eval, paste0(
  "results/skewed_t_quantiles_prediction/fitted_mean/skewed_t_prediction_ar1_eval_", 
  timestamp, ".csv"), row.names = FALSE)
...
write.csv(pred_arima1_1_0, paste0(
  "results/skewed_t_quantiles_prediction/fitted_mean/skewed_t_prediction_arima1_1_0_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_arima1_1_0_eval, paste0(
  "results/skewed_t_quantiles_prediction/fitted_mean/skewed_t_prediction_arima1_1_0_eval_", 
  timestamp, ".csv"), row.names = FALSE)
...
write.csv(pred_arima_auto, paste0(
  "results/skewed_t_quantiles_prediction/fitted_mean/skewed_t_prediction_arima_auto_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_arima_auto_eval, paste0(
  "results/skewed_t_quantiles_prediction/fitted_mean/skewed_t_prediction_arima_auto_eval_", 
  timestamp, ".csv"), row.names = FALSE)
...
write.csv(pred_rw_q, paste0(
  "results/skewed_t_quantiles_prediction/quarterly/fitted_mean/skewed_t_prediction_rw_q_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_rw_q_eval, paste0(
  "results/skewed_t_quantiles_prediction/quarterly/fitted_mean/skewed_t_prediction_rw_q_eval_", 
  timestamp, ".csv"), row.names = FALSE)
...
write.csv(pred_ar1_q, paste0(
  "results/skewed_t_quantiles_prediction/quarterly/fitted_mean/skewed_t_prediction_ar1_q_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_ar1_q_eval, paste0(
  "results/skewed_t_quantiles_prediction/quarterly/fitted_mean/skewed_t_prediction_ar1_q_eval_", 
  timestamp, ".csv"), row.names = FALSE)
...
write.csv(pred_arima1_1_0_q, paste0(
  "results/skewed_t_quantiles_prediction/quarterly/fitted_mean/skewed_t_prediction_arima1_1_0_q_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_arima1_1_0_q_eval, paste0(
  "results/skewed_t_quantiles_prediction/quarterly/fitted_mean/skewed_t_prediction_arima1_1_0_q_eval_", 
  timestamp, ".csv"), row.names = FALSE)
...
write.csv(pred_arima_auto_q, paste0(
  "results/skewed_t_quantiles_prediction/quarterly/fitted_mean/skewed_t_prediction_arima_auto_q_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_arima_auto_q_eval, paste0(
  "results/skewed_t_quantiles_prediction/quarterly/fitted_mean/skewed_t_prediction_arima_auto_q_eval_", 
  timestamp, ".csv"), row.names = FALSE)
