#'!!! Generative AI; level = high --> all code for plots was generated by AI
#'and then adjusted by me
#'data preparation only debugging + other syntax, for instance refactoring labels. 
