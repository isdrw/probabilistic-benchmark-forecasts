...
source("scripts/t quantiles prediction/t_quantiles_functions.R")
...
with_progress({
  ...
  weo_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_t_student(df_weo, country, tau, target, horizon, fit_mean = TRUE)    
      })
...
with_progress({
  ...
  rw_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_t_student(df_rw, country, tau, target, horizon, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  ar1_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_t_student(df_ar1, country, tau, target, horizon, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  arima1_1_0_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_t_student(df_arima1_1_0, country, tau, target, horizon, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  arima_auto_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_t_student(df_arima_auto, country, tau, target, horizon, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  rw_q_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_t_student(df_rw_q, country, tau, target, horizon, R = 44, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  ar1_q_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_t_student(df_ar1_q, country, tau, target, horizon, R = 44, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  arima1_1_0_q_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_t_student(df_arima1_1_0_q, country, tau, target, horizon, R = 44, fit_mean = TRUE)  
      })
...
with_progress({
  ...
  arima_auto_q_list <- future_pmap(
    ...
    function(country, tau, target, horizon) {
      suppressWarnings({
        res <- fit_t_student(df_arima_auto_q, country, tau, target, horizon, R = 44, fit_mean = TRUE)  
      })
...
write.csv(pred_arima_auto, paste0(
  "results/t_quantiles_prediction/fitted_mean/t_prediction_arima_auto_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_arima_auto_eval, paste0(
  "results/t_quantiles_prediction/fitted_mean/t_prediction_arima_auto_eval_", 
  timestamp, ".csv"), row.names = FALSE)
...
write.csv(pred_rw_q, paste0(
  "results/t_quantiles_prediction/quarterly/fitted_mean/t_prediction_rw_q_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_rw_q_eval, paste0(
  "results/t_quantiles_prediction/quarterly/fitted_mean/t_prediction_rw_q_eval_", 
  timestamp, ".csv"), row.names = FALSE)
...
write.csv(pred_ar1_q, paste0(
  "results/t_quantiles_prediction/quarterly/fitted_mean/t_prediction_ar1_q_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_ar1_q_eval, paste0(
  "results/t_quantiles_prediction/quarterly/fitted_mean/t_prediction_ar1_q_eval_", 
  timestamp, ".csv"), row.names = FALSE)
...
write.csv(pred_arima1_1_0_q, paste0(
  "results/t_quantiles_prediction/quarterly/fitted_mean/t_prediction_arima1_1_0_q_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_arima1_1_0_q_eval, paste0(
  "results/t_quantiles_prediction/quarterly/fitted_mean/t_prediction_arima1_1_0_q_eval_", 
  timestamp, ".csv"), row.names = FALSE)
...
write.csv(pred_arima_auto_q, paste0(
  "results/t_quantiles_prediction/quarterly/fitted_mean/t_prediction_arima_auto_q_", 
  timestamp, ".csv"), row.names = FALSE)

write.csv(pred_arima_auto_q_eval, paste0(
  "results/t_quantiles_prediction/quarterly/fitted_mean/t_prediction_arima_auto_q_eval_", 
  timestamp, ".csv"), row.names = FALSE)
